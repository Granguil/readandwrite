...
var functions = {
  ...
  loadContentById: function loadContentById(data, c, sc, sb, niv, display, cardNumber, test) {
    configByDefault.content = data.Elements;
    configByDefault.displayContent = data.Blocks;
    test(data, c, sc, sb, niv, display, cardNumber);
  }
};
var configByDefault = {
...
function BookMarkCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: Style.w100
  }, /*#__PURE__*/React.createElement("h3", null, resources.Bookmark), /*#__PURE__*/React.createElement("div", {
    className: Style.enveloppe
  }, bookMarks.length > 0 ? bookMarks.map(function (bm, index) {
    return /*#__PURE__*/React.createElement("div", {
      key: index,
      className: Style.displayinfo
  ...
  }) : /*#__PURE__*/React.createElement("div", null, resources.createBookMark))));
}

function ExplorerDisplay(_ref) {
  var loadFunction = _ref.loadFunction,
      loadElementsById = _ref.loadElementsById,
      userId = _ref.userId,
      ...
      readValidated = _ref.readValidated,
      resources = _ref.resources;
  configByDefault.resources = resources;

  var dbf = _extends({}, displayByDefault);

  dbf.titles = [resources !== undefined ? resources.firstTitle : '', resources !== undefined ? resources.secondTitle : '', resources !== undefined ? resources.thirdTitle : '', resources !== undefined ? resources.fourthTitle : ''];
  configByDefault.displayByDefault = _extends({}, dbf);
  ...
  console.log('Content Start of Component');
  console.log(Content);
  console.log(Block);
  useEffect(function () {
  ...
  var _navigation = function navigation(niveau, id) {
    ...
    if (configByDefault.general.loadAll) {
      if (configByDefault.general.displayAllCard) {
        if (niveau + 1 < configByDefault.general.cardNumber) {
          console.log('Element');
          console.log(configByDefault.content);
          console.log(id);
      ...
      loadElementsById(function (data) {
        configByDefault.functions.loadContentById(data, c, setContent, setBlock, niveau, configByDefault.general.displayAllCard, configByDefault.general.cardNumber, function (d, c, setContent, setBlock, niveau, displayall, cardNumber) {
          if (displayall) {
            if (niveau + 1 < c.length) {
              c[niveau + 1] = d.Elements;
              setBlock([]);
              setContent([].concat(c));
            } else {
              setBlock([].concat(d.Blocks));
            }
          } else {
            if (niveau + 1 < cardNumber) {
              c.push([].concat(d.Elements));
              setBlock([]);
              setContent([].concat(c));
            } else {
              setBlock([].concat(d.Blocks));
  ...
  }) : null), Block.length > 0 && Block[0] !== undefined ? /*#__PURE__*/React.createElement("div", {
    className: Style.displayCards
...
var Explorer = function Explorer(_ref) {
  var load = _ref.load,
      _loadElementsById = _ref.loadElementsById,
      userId = _ref.userId,
      createBookMark = _ref.createBookMark,
  ...
  return /*#__PURE__*/React.createElement(ExplorerDisplay, {
    ...
    loadElementsById: function loadElementsById(data, niveau, id) {
      return _loadElementsById(data, niveau, id);
    },
    userId: userId,
