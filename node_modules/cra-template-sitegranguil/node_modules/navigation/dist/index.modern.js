...
var getNavigation = function getNavigation(data) {
  var navTab = {};
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(data), _step; !(_step = _iterator()).done;) {
    ...
    navTab[d.groupe] = [].concat(navTab[d.groupe], [[d.nom, d.adresse]]);
  }
...
var navigation = {
  groupe: [],
  load: function load(fetchRequest, contentObject, loader) {
    fetchRequest(JSON.stringify(contentObject), function (data) {
      console.log(data);
      navigation.groupe = getNavigation(data);
      loader(true);
    });
  }
};
...
function NavigationMenu(_ref) {
  ...
  useEffect(function () {
    navigation.load(fetchRequest, contentObject, loader);
    alert('nav');
